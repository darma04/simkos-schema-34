"""
==========================================================================
 BOOTSTRAP LAYOUT HORIZONTAL - Inisialisasi Layout Horizontal
   ==========================================================================
   File Python untuk menginisialisasi context layout horizontal.
   Menyiapkan: menu horizontal, breadcrumb, template variables.
"""
